...
/*────────────────────────────── 🎨 STYLES (Optimized & Responsive) ──────────────────────────────*/ const styles =
  StyleSheet.create({
    modalWrapper: {
      flex: 1,
    ...
    actionButton: { flexDirection: "row", alignItems: "center", gap: wp(1) },
    actionNumber: { fontSize: wp(3.4), color: COLORS.textSecondary },
    caption: {
      fontSize: wp(3.6),
      color: COLORS.textSecondary,
      lineHeight: wp(5.2),
